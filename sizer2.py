...
for jj, thrust in enumerate(thrSweep):
    ...
    for ii, mLaunch in enumerate(mSeparated):
        ...
        if engMain.strCryo == 'Cryo':
            ...
            CoastToTCM2 = cf.Phase('Coast to TCM2', TCM1.mEnd, 0, engMain, 'Coast', 0, mdotRCS, mdotOxBoiloff,
                                   mdotFuelBoiloff)
            TCM2 = cf.Phase('TCM2', CoastToTCM2.mEnd, 5, engRCS, 'Coast', 0, mdotRCS, mdotOxBoiloff, mdotFuelBoiloff)
            # Replace the TIME_HERE below wit 1 day (i.e. 1*86400)
            CoastToTCM3 = cf.Phase('Coast to TCM3', TCM2.mEnd, 0, engMain, 'Coast', 0, mdotRCS, mdotOxBoiloff,
                                   mdotFuelBoiloff)
            TCM3 = cf.Phase('TCM3', CoastToTCM3.mEnd, 5, engRCS, 'Coast', 0, mdotRCS, mdotOxBoiloff, mdotFuelBoiloff)
            ...
            PreLOIChill = cf.Phase('Pre-LOI Chill', PreLOISett.mEnd, 0, engMain, 'Chill', 0, mdotRCS, mdotOxBoiloff,
                                   mdotFuelBoiloff)
            LOI = cf.Phase('LOI', PreLOIChill.mEnd, 850, engMain, 'Burn', 0, mdotRCS, mdotOxBoiloff,
                           mdotFuelBoiloff)
